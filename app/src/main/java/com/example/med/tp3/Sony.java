...
public class Sony extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put("img", String.valueOf(R.drawable.xperiaz3));
        ...
        map = new HashMap<>();
        map.put("name", "sony xperia z5");
        map.put("prix", " 729  €");
        map.put("img", String.valueOf(R.drawable.xperaiz5));
        listItem.add(map);

        map = new HashMap<>();
        map.put("name", "sony z2");
        map.put("prix", "324,55 €");
        map.put("img", String.valueOf(R.drawable.sonyz2));
        listItem.add(map);
        ...
        maListViewPerso.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder adb = new AlertDialog.Builder(Sony.this);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // On récupère la "HashMap" contenant les infos de notre item (titre, description, img)
                HashMap<String, String> map = (HashMap<String, String>) maListViewPerso.getItemAtPosition(position);
                Toast.makeText(Sony.this, map.get("name"), Toast.LENGTH_LONG).show();
            }
        });
        final Context context = Sony.this;
