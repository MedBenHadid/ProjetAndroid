...
public class Iphone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put("img", String.valueOf(R.drawable.iphonex));
        ...
        map = new HashMap<>();
        map.put("name", "Iphone 8");
        map.put("prix", "800 €");
        map.put("img", String.valueOf(R.drawable.iphone8));
        listItem.add(map);

        map = new HashMap<>();
        map.put("name", "Iphone 7");
        map.put("prix", "739 €");
        map.put("img", String.valueOf(R.drawable.iphone7));
        listItem.add(map);
        ...
        maListViewPerso.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder adb = new AlertDialog.Builder(Iphone.this);
